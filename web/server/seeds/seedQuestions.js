// Generate and seed training questions for VoltPal via Claude API
...
async function main() {
  console.log("=== Seeding VoltPal Training Questions ===\n");
