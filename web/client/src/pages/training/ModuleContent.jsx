...
const SECTION_STYLES = {
  ...
  tip: { borderLeft: '4px solid #FACC15' },
};
    ...
    <div className="card" style={{ ...style, position: 'relative' }}>
      {label && (
        <p style={{
          fontSize: '0.8125rem',
          fontWeight: 600,
          color: section.content_type === 'tip' ? '#FACC15'
      ...
      {!section.is_read && (
        <button
          ...
          style={{ marginTop: '0.75rem', fontSize: '0.8125rem', color: '#FACC15' }}
      ...
      <div className="stack">
        <div className="card" style={{ textAlign: 'center' }}>
          <p style={{
            fontSize: '2.5rem',
            fontWeight: 700,
            color: scoreData.passed ? '#FACC15' : '#F59E0B',
          }}>
          ...
          <div className="card">
            ...
            {scoreData.topic_breakdown.map((t) => (
              <div key={t.topic} className="row-between" style={{ padding: '0.375rem 0', borderBottom: '1px solid #2A2A2E' }}>
                ...
                <span style={{ fontSize: '0.875rem', color: t.percent >= 70 ? '#FACC15' : '#F59E0B' }}>
                  ...
                  {q.options.map((opt) => {
                    ...
                    return (
                      <div key={opt.key} style={{
                        ...
                        borderRadius: 8,
                        border: '1px solid',
                        borderColor: isCorrect ? '#FACC15' : wasSelected ? '#EF4444' : '#2A2A2E',
      ...
      <div className="card">
        ...
        <div className="stack-sm">
          {q.options.map((opt) => {
            ...
            let border = '#2A2A2E';
            if (isRevealed) {
              if (opt.key === q.correct_answer) { bg = 'rgba(51,204,51,0.1)'; border = '#FACC15'; }
              else if (opt.key === selected) { bg = 'rgba(239,68,68,0.1)'; border = '#EF4444'; }
            } else if (opt.key === selected) {
              bg = 'rgba(51,204,51,0.08)'; border = '#FACC15';
            }
