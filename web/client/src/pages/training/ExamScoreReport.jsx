      ...
      <div className="stack">
        ...
        <div className="card" style={{ textAlign: 'center' }}>
          <div style={{
            ...
            borderRadius: '50%',
            border: `4px solid ${passed ? '#FACC15' : '#EF4444'}`,
            marginBottom: '0.75rem',
          }}>
            <span style={{
              fontSize: '1.5rem',
              fontWeight: 700,
              color: passed ? '#FACC15' : '#EF4444',
            }}>
              {passed ? 'PASS' : 'FAIL'}
            </span>
          </div>
                ...
                <div key={d.domain} style={{ padding: '0.5rem 0', borderBottom: '1px solid #2A2A2E' }}>
                  ...
                  <div style={{ height: 4, backgroundColor: '#2A2A2E', borderRadius: 2, overflow: 'hidden' }}>
                    <div style={{
                      height: '100%',
                      width: `${d.percent}%`,
                      backgroundColor: d.percent >= pass_threshold ? '#FACC15' : '#EF4444',
                      borderRadius: 2,
                    }} />
                  </div>
                </div>
