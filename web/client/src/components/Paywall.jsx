...
export default function Paywall() {
  ...
  const defaultOffering = offerings?.all?.['VoltPal'];
        ...
        {annualPkg && (
          <button
            ...
            style={{
              ...
              padding: '1rem',
              borderRadius: 12,
              border: selected === 'Annual' ? '2px solid #FACC15' : '2px solid #2A2A2E',
              background: selected === 'Annual' ? 'rgba(250,204,21,0.08)' : 'transparent',
              cursor: 'pointer',
              textAlign: 'center',
              position: 'relative',
            }}
          >
            ...
            <p style={{ fontSize: '1.25rem', fontWeight: 700, color: '#FACC15', margin: '0.25rem 0' }}>
        ...
        {monthlyPkg && (
          <button
            ...
            style={{
              ...
              padding: '1rem',
              borderRadius: 12,
              border: selected === 'Monthly' ? '2px solid #FACC15' : '2px solid #2A2A2E',
              background: selected === 'Monthly' ? 'rgba(250,204,21,0.08)' : 'transparent',
              cursor: 'pointer',
              textAlign: 'center',
            }}
          >
